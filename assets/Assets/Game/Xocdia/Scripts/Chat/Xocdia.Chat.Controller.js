cc.Class({
    ...
    init(obj) {
        ...
        this.quickchat_text_list.forEach(chatText => {
            ...
            const nodeComp = node.getComponent("Xocdia.Chat.QuickText.Item.Controller");
            nodeComp.init(this);
        ...
        this.quickchat_emoji_list.forEach(chatEmoji => {
            ...
            const nodeComp = node.getComponent("Xocdia.Chat.QuickEmoji.Item.Controller");
            nodeComp.init(this);
    ...
    MessagePush: function (type, username, message, color_username = "#FFC200", color_content = "#FFFFFF") {
        ...
        const nodeComp = node.getComponent("Xocdia.Chat.Item.Controller");
        nodeComp.init(this);
