...
cc.Class({
    ...
    onChangerAmount: function (value = 0) {
        ...
        this.amountSuggestNode.children.forEach(node => {
            if (node.name == cc.CORE.UTIL.getOnlyNumberInString(value)) {
    ...
    onClickSubmit: function () {
        cc.CORE.GAME_SCENCE.PlayClick();
        const config = this.CORE.config["bank"]["auto"]["config"];
        ...
        HttpRequest.Post(
            ...
            if (result.error_code == 0) {
                ...
                this.resp_bank.string = cc.CORE.UTIL.cutText(`${data.bank_code.toUpperCase()}`, 21);
